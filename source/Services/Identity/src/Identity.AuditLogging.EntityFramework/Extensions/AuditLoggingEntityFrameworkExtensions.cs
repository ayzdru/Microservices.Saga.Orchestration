...
using Identity.AuditLogging.EntityFramework.DbContexts.Default;
...
using Identity.AuditLogging.Extensions;

namespace Identity.AuditLogging.EntityFramework.Extensions
{
