using Identity.Api.AuditLogging;
using Identity.Api.Configuration;
using Identity.Api.Configuration.ApplicationParts;
using Identity.Api.Configuration.Constants;
using Identity.Api.Helpers.Localization;
...
using Identity.AuditLogging.EntityFramework.Services;
...
public static class StartupHelpers
{
    ...
    where TDataProtectionDbContext : DbContext, IDataProtectionKeyContext
    {
        ...
        var healthChecksBuilder = services.AddHealthChecks()
            ...
            .AddIdentityServer(new Uri(identityServerUri), tags: ["Identity Server"]);
